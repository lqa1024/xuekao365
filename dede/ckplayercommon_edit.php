...
else if($dopost=="gettag")
{
	...
	$showhtml .= "}\r\n";
	$showhtml .= "</script>\r\n";
	$showhtml .= "<br/>PC端模板调用代码：<br/><br/>\r\n";
    $showhtml .= "<textarea name=\"rongqi1\" id=\"rongqi1\" style=\"width:50%;height:100px; border:1px solid #cccccc; background:#FFF;\" rows=\"10\">\r\n";
	$showhtml .= "<script src=\"{dede:global.cfg_cmsurl/}/ckplayer/index.php?id=$id\" language=\"javascript\"></script>\r\n";
    $showhtml .= "{dede:include filename=\"../../ckplayer/views/ckplayer.htm\"/}";
...
else if($dopost=="saveedit")
{
	...
	mheight='$mheight',volume='$volume',logotime='$logotime',
	endmotion='$endmotion',cthidden='$cthidden',cthidtime='$cthidtime',
	adpre='$adpre',adpreurl='$adpreurl',adpretime='$adpretime',advolume='$advolume',
	adpreorder='$adpreorder',adprejp='$adprejp',adpremute='$adpremute',adpreload='$adpreload',adpau='$adpau',
...
$ckData = $dsql->GetOne("SELECT * FROM #@__ckcommon WHERE id=$id");
