...
if($dopost=="add")
{
	...
	stylename,skin,autoplay,dwidth,dheight,mwidth,mheight,volume,logotime,
	endmotion,cthidden,cthidtime,adpre,adpreurl,adpretime,advolume,adpreorder,
	adprejp,adpremute,adpreload,adpau,adpauurl,adpaucls,admarstatus,admarcontent,admarurl,
	admarcolor,admarbgc,admarbgt,admarlight,lightcolor,lightc,savetime) VALUES(
	'$stylename','$skin','$autoplay','$dwidth','$dheight','$mwidth','$mheight','$volume',
	'$logotime','$endmotion','$cthidden','$cthidtime',
	'$adpre','$adpreurl','$adpretime','$advolume','$adpreorder','$adprejp','$adpremute','$adpreload',
