...
$sql = "SELECT id,stylename,skin,endmotion,dwidth,dheight,mwidth,mheight,savetime FROM `#@__ckcommon` WHERE  CONCAT(`id`,`stylename`,`skin`,`admarcontent`) LIKE '%$keyword%' ORDER BY id desc";
