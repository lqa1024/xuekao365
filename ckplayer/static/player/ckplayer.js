...
function ckstyle() {
    var ck = {
        ...
        language: '',
        flashvars: '{h->3}{wh->}',
        setup: '1,1,1,'+ckdata['adpreload']+',1,1,'+ckdata['adpreorder']+',1,'+ckdata['admarstatus']+',0,0,1,200,0,1,'+ckdata['adpaucls']+',0,1,1,1,2,10,3,0,1,'+ckdata['cthidden']+','+ckdata['cthidtime']+',1,0,1,0,1,1,1,1,1,1,250,'+ckdata['logotime']+','+ckdata['advolume']+',0,0,0',
        pm_bg: '0x000000,100,230,180',
        mylogo: 'logo.swf',
        pm_mylogo: '1,1,-100,-55',
        logo: 'cklogo.png',
        pm_logo: '0,0,10,20',
        control_rel: 'related.swf,'+videoinfo['path']+'/ckplayer/index.php?c=CkPlayer&a=outXml&type=related,1',
        control_pv: 'Preview.swf,105,2000',
        pm_repc: '',
        pm_spac: '|',
        pm_fpac: '',
        pm_advtime: '2,0,-110,10,0,300,0',
        pm_advstatus: ''+ckdata['adpremute']+',2,2,-200,-100',
        pm_advjp: ''+ckdata['adprejp']+',0,2,2,-100,-100',
        pm_padvc: '2,0,-10,-10',
        pm_advms: '2,0,-46,35',
        ...
        cpt_lights: '1',
        cpt_share: videoinfo['path']+'/ckplayer/index.php?c=CkPlayer&a=outXml&type=share',
        cpt_list: ckcpt()
    }
    return ck;
}
    ...
    var CKobject = {
		...
		embed:function(f,d,i,w,h,b,v,e,p,j){
			...
			if(b){
				...
				else if(this.isHTML5() && !(this.Platform()=='webKit' && this.browser()['B']=='chrome')){
					this.embedHTML5(d,i,w,h,e,v,s,j);
                }
				else{
					this.embedSWF(f,d,i,w,h,v,p);
